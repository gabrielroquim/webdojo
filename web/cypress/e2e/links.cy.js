describe('links abrindo nova guia/janela', () => {
    it('Validando o atributo do kink no instagran', () => {
        cy.start()
    ...
    it('Acessar links de termos de uso removendo o target _blank', () => {
        cy.start()
        cy.submitLoginForm('papito@webdojo.com', 'katana123')
        ...
        cy.contains('a', 'termos de uso')
            .invoke('removeAttr', 'target') // aqui vc vai remover o _blanc, com isso não vai abrir numa nova pagina
            .click()
